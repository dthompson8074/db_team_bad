...
FROM [dbo].[crime]
GROUP BY [Start Date   Time], [Class Description]
...
SELECT	[Count Table].[Start Date   Time]
		,[Count Table].[Class Description]
		,[Count Table].[Number of Incidents]
		,[Percentage Table].[Incident Percentage]
FROM [Count Table]
INNER JOIN [Percentage Table] ON [Count Table].[Class Description]=[Percentage Table].[Class Description] AND [Count Table].[Start Date   Time]=[Percentage Table].[Start Date   Time]
ORDER BY [Count Table].[Start Date   Time], [Count Table].[Number of Incidents] DESC
